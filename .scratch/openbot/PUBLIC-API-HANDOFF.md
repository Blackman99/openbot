...
API-02 is implemented and its actual service gate is closed by Verify33960029570. API-03 is complete: its actual service gate is closed by [Verify 34017551070](https://github.com/Blackman99/openbot/actions/runs/34017551070). The shared authority and dependency decisions below still apply.
